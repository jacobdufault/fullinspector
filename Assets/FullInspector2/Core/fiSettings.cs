...
namespace FullInspector {
    ...
    public class fiSettings {
        /// <summary>
        /// If true, multi-object editing will be enabled. Note that multi-object editing is still
        /// extremely experimental and has a large number of bugs.
        /// </summary>
        ...
        /// <summary>
        /// If true, then fiSettingsProcessor support will be enabled. The initial fiSettingsProcessor
        /// initialization may take some time so it is sometimes desirable turn this off by setting
        /// EnableSettingsProcessor to false.
        ///
        /// If you're using a DLL, the only way to customize settings (outside of compiling a DLL with your
        /// fiSettings config options baked in) is to use a fiSettingsProcessor instance.
        ///
        /// Note that this setting will *only* be honored if modified directly here, before the static
        /// constructor is run. It cannot be modified from a fiSettingsProcessor.
        /// </summary>
