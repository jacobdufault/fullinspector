...
namespace FullInspector {
    /// <summary>
    /// Adds a tooltip to an field or property that is viewable in the
    /// inspector. If you add this to a MonoBehaviour derived class, the
    /// tooltip text will appear in the "Name" field that appears at the start
    /// of every inspector.
    /// </summary>
