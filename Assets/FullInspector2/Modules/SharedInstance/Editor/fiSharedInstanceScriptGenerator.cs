...
namespace FullInspector.Modules {
    ...
    public static class fiSharedInstanceScriptGenerator {
        ...
        /// The value for the serializer type, optional. It will also go in a
        /// generic type argument.
        /// </param>
        private static void Emit(string className, string genericType, string serializerName) {
            // Get the file path we will generate. If there is already a file
            // there, it is assumed that we are the ones who generated it and so
