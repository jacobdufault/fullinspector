...
namespace FullInspector {
    /// <summary>
    /// <para>
    /// You can use this interface to customize how rendering of items inside of
    /// an collection is done. Usage is slightly unintuitive because C#
    /// annotations are not very expressive.
    /// </para>
    /// <para>
    ...
    public sealed class InspectorCollectionItemAttributesAttribute : Attribute {
        // ICustomAttributeProvider not necessarily available, so we just use
        // MemberInfo instead
